...
<head>
    ...
    <script>
         ...
         * Aufgabe 1 
         */
        // Die Funktion greet hat ein Parameter, diesen Weisen wir im Funktionsblock den Wert
        // Hans hinzu und geben es in der Konsole aus
        function greet(name) {
            name = "Hans";
         ...
         * Aufgabe 6
         */
        function calculateDistance(geschwinigkeit, zeit, container) {
            // TODO: Diese Funktion muss (inklusive Funktionsparameter) implementiert werden. 
            // Orientiere dich an der Funktion aus Aufgabe 5.
            let strecke = geschwinigkeit * zeit;
            document.getElementById(container).innerHTML = strecke;
        }
    </script>
</head>
...
<body>
    ...
    <button onclick="greet('Claudia')">Grüße senden</button>

    <p>
        2) Füge dem nachfolgenden Button die Funktion <code>multiply()</code> hinzu. Übergebe an die Funktion die Parameter <code>7</code> und <code>8</code>. <br> Auf der Console soll der Text "Das Ergebnis ist 56" ausgegeben werden.
    </p>
    <button onclick="multiply(7,8)">7 * 8</button>
    ...
    <button onclick="eatCookie(2)">Keks essen</button>


    <p>5) Der Satz des Pythagoras ist jedem noch aus der Schulzeit bekannt: <code>a² + b² = c²</code>. In dieser Übung rechnen wir unser c² für verschiedene Werte von a und b aus.<br>
    ...
    <table>
        ...
        <tr>
            ...
            <td>2² + 5²</td>
            <td id="result2"></td>
            <td><button onclick="pythagoras(2, 5, 'result2')">Berechnen</button></td>
        </tr>
    ...
    <table>
        ...
        <tr>
            ...
            <td>24 Stunden</td>
            <td id="distance1"></td>
            <td><button onclick="calculateDistance(5, 24, 'distance1')">Berechnen</button></td>
        </tr>
        ...
        <tr>
            ...
            <td>24 Stunden</td>
            <td id="distance2"></td>
            <td><button onclick="calculateDistance(12, 24, 'distance2')">Berechnen</button></td>
        </tr>
        ...
        <tr>
            ...
            <td>24 Stunden</td>
            <td id="distance3"></td>
            <td><button onclick="calculateDistance(18, 24, 'distance3')">Berechnen</button></td>
        </tr>
        ...
        <tr>
            ...
            <td>24 Stunden</td>
            <td id="distance4"></td>
            <td><button onclick="calculateDistance(100, 24, 'distance4')">Berechnen</button></td>
        </tr>
        ...
        <tr>
            ...
            <td>24 Stunden</td>
            <td id="distance5"></td>
            <td><button onclick="calculateDistance(800, 24, 'distance5')">Berechnen</button></td>
        </tr>
        ...
        <tr>
            ...
            <td>24 Stunden</td>
            <td id="distance6"></td>
            <td><button onclick="calculateDistance(28800, 24, 'distance6')">Berechnen</button></td>
        </tr>
    </table>
</body>
